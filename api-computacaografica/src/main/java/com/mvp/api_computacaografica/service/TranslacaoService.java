...
public class TranslacaoService {
    ...
    public TranslacaoService(ApiComputacaoGraficaClient cliente, ReceberImagemURLService imageService) {
    ...
    public void processar(String urlFoto, int x, int y, String meuToken) throws Exception {
        ...
        cliente.translatarFoto("b982015b7d32306d48c0", requestDto);
